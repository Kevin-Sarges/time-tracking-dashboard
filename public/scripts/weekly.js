  ...
  success: function (data) {
    ...
    weeklyWork.innerHTML = `
      <div class="hours">
        ...
        <div class="text-hours">
          <p id="time">${data[0].timeframes.weekly.current}</p>
    ...
    weeklyPlay.innerHTML = `
      <div class="hours">
        ...
        <div class="text-hours">
          <p id="time">${data[1].timeframes.weekly.current}</p>
    ...
    weeklyStudy.innerHTML = `
      <div class="hours">
        ...
        <div class="text-hours">
          <p id="time">${data[2].timeframes.weekly.current}</p>
    ...
    weeklyExercise.innerHTML = `
      <div class="hours">
        ...
        <div class="text-hours">
          <p id="time">${data[3].timeframes.weekly.current}</p>
    ...
    weeklySocial.innerHTML = `
      <div class="hours">
        ...
        <div class="text-hours">
          <p id="time">${data[4].timeframes.weekly.current}</p>
    ...
    weeklySelf.innerHTML = `
      <div class="hours">
        ...
        <div class="text-hours">
          <p id="time">${data[5].timeframes.weekly.current}</p>
