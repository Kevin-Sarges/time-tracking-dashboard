    ...
    success: function (data) {
      ...
      monthlyWork.innerHTML = `
        <div class="hours">
          ...
          <div class="text-hours">
            <p id="time">${data[0].timeframes.monthly.current}hrs</p>
      ...
      monthlyPlay.innerHTML = `
        <div class="hours">
          ...
          <div class="text-hours">
            <p id="time">${data[1].timeframes.monthly.current}hrs</p>
      ...
      monthlyStudy.innerHTML = `
        <div class="hours">
          ...
          <div class="text-hours">
            <p id="time">${data[2].timeframes.monthly.current}hrs</p>
      ...
      monthlyExercise.innerHTML = `
        <div class="hours">
          ...
          <div class="text-hours">
            <p id="time">${data[3].timeframes.monthly.current}hrs</p>
      ...
      monthlySocial.innerHTML = `
        <div class="hours">
          ...
          <div class="text-hours">
            <p id="time">${data[4].timeframes.monthly.current}hrs</p>
      ...
      monthlySelf.innerHTML = `
        <div class="hours">
          ...
          <div class="text-hours">
            <p id="time">${data[5].timeframes.monthly.current}hrs</p>
